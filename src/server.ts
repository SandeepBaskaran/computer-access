...
import { registerBridgeTools, bridge } from "./tools/bridgeTools.js";
import { allowedDirsInfo, ALLOWED_DIRS_FILE } from "./config.js";
...
function createMcpServer(sessionId: string) {
  ...
  registerBridgeTools(registerGuardedTool, sessionId);
...
app.get("/status", (_req, res) => res.json({
  ...
  bridgeOps: (() => { const o = bridge.ops(); return { ...o, reattachedJobs: o.reattachedJobs.length }; })(),
